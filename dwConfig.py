...
LoT = 45        # Below which overall score will be 0. Above which temp score increases to max at MidLoT
MidLoT = 70     # Above which temp score will be max until MidHiT is reached
MidHiT = 83     # Above which temp score decreases to 0 at HiT
HiT = 95        # Above which overall score will be 0
LoW = 5         # Below which wind score will be Max. Wind score decreases to 0 at HiW
HiW = 17        # Above which overall score will be 0
LoP = 15        # Below which precip score will be Max. Precip score decreases to 0 at HiP
HiP = 60        # Above which overall score will be 0
